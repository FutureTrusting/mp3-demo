...
import com.fengwenyi.mp3demo.dto.MedtronicUserInfoDTO;
import com.fengwenyi.mp3demo.dto.PersonDto;
import com.fengwenyi.mp3demo.java8.utils.JsonMapper;
...
public class StreamUtil {
     ...
     * @since JDK1.8
     */
//    public static <T> CompletableFuture<List<T>> sequence(StreamUtil<CompletableFuture<T>> futures) {
